...
#ifndef SDK_LIB_SWIFT_H
#define SDK_LIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SDK_Lib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7SDK_Lib10AdResponse")
@interface AdResponse : UIViewController
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <ISImpressionDataDelegate>
- (void)impressionDataDidSucceed:(ISImpressionData * _Null_unspecified)impressionData;
@end
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <CHBBannerDelegate>
- (void)didFinishHandlingClick:(CHBClickEvent * _Nonnull)event error:(CHBClickError * _Nullable)error;
@end


@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <UnityAdsLoadDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <UnityAdsInitializationDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <CHBRewardedDelegate>
- (void)didEarnReward:(CHBRewardEvent * _Nonnull)event;
- (void)didDismissAd:(CHBDismissEvent * _Nonnull)event;
@end


@protocol GADFullScreenPresentingAd;

@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <GADFullScreenContentDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <WKNavigationDelegate, WKUIDelegate>
@end
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <UADSBannerViewDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <UnityAdsShowDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <CHBInterstitialDelegate>
- (void)didCacheAd:(CHBCacheEvent * _Nonnull)event error:(CHBCacheError * _Nullable)error;
- (void)willShowAd:(CHBShowEvent * _Nonnull)event;
- (void)didShowAd:(CHBShowEvent * _Nonnull)event error:(CHBShowError * _Nullable)error;
- (void)didClickAd:(CHBClickEvent * _Nonnull)event error:(CHBClickError * _Nullable)error;
@end
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <AdColonyInterstitialDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <LevelPlayBannerDelegate>
- (void)didLoad:(ISBannerView * _Null_unspecified)bannerView withAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
- (void)didFailToLoadWithError:(NSError * _Null_unspecified)error;
- (void)didClickWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
- (void)didLeaveApplicationWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
- (void)didPresentScreenWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
- (void)didDismissScreenWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
@end

@class GADBannerView;

@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <GADBannerViewDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <AdColonyAdViewDelegate>
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <LevelPlayInterstitialDelegate>
- (void)didLoadWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
- (void)didOpenWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
- (void)didShowWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
...
@interface AdResponse (SWIFT_EXTENSION(SDK_Lib)) <LevelPlayRewardedVideoDelegate>
- (void)hasAvailableAdWithAdInfo:(ISAdInfo * _Null_unspecified)adInfo;
...
@interface UINavigationController (SWIFT_EXTENSION(SDK_Lib))
